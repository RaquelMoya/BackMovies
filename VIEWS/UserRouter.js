...
//http://localhost:3500/users/email/:email



//Registro Usuarios
router.post("/", UserController.registerUser);
//http://localhost:3500/users (usando POST)

//Login Usuarios
router.post("/login", UserController.loginUser);
//http://localhost:3500/users/login (usando POST)


//Modificar Password
router.put("/newpassword", auth, UserController.updatePassword);
//http://localhost:3500/users/newpassword (usando PUT)



//Borrar usuarios
router.delete("/", auth, isAdmin,  UserController.deleteAll);
//http://localhost:3500/users (usando DEL)

//Borrar usuario mediante su id
router.delete("/delete/:id",auth,  isAdmin,  UserController.deleteById);
//http://localhost:3500/users/delete/:id (usando DEL)
