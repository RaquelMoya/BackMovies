...
//name,surname,age,phone,adress,email, password
  up: async (queryInterface, Sequelize) => {
    ...
    {"name":"Bonnie", "surname": "Winterbottom", "age": 42, "phone": 763245, "adress": "c/cinco", "email":"bonnie0@trellian.com","password":bcrypt.hashSync("htrads", Number.parseInt(authConfig.rounds)), "nickname": "ytsdcvxc","rol": false,"createdAt":"2021-10-27","updatedAt":"2021-10-27"},
    {"name":"Laurel", "surname": "Castillo", "age": 25, "phone": 6534223, "adress": "c/seis", "email":"laurel@trellian.com","password":bcrypt.hashSync("asfdfd", Number.parseInt(authConfig.rounds)), "nickname": "jytsdc","rol": false,"createdAt":"2021-10-27","updatedAt":"2021-10-27"},
    {"name":"Usher", "surname": "Milston", "age": 23, "phone": 35431, "adress": "c/siete", "email":"milston0@trellian.com","password":bcrypt.hashSync("gfdsdc", Number.parseInt(authConfig.rounds)), "nickname": "bvcsds","rol": false,"createdAt":"2021-10-27","updatedAt":"2021-10-27"},
    {"name":"Connor", "surname": "Wals", "age": 29, "phone": 642345, "adress": "c/ocho", "email":"connor@trellian.com","password":bcrypt.hashSync("hgasdc", Number.parseInt(authConfig.rounds)), "nickname": "ynsdc","rol": false,"createdAt":"2021-10-27","updatedAt":"2021-10-27"}
  ],{});
},
